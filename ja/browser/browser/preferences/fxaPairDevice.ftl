...
fxa-qrcode-pair-step2 = 2. <strong>メニュー</strong> (iOS では <img data-l10n-name="ios-menu-icon"/>、Android では <img data-l10n-name="android-menu-icon"/>) を開いて、<strong>ログインして同期</strong> をタップします
