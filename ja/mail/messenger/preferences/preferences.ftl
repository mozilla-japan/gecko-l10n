...
default-message-list-description = 新しく作成したフォルダーについて、@@Default@@の並べ替えとスレッド表示のオプションを指定します。
default-flag-label =
...
default-sort-ascending =
    .label = 昇順
default-sort-ascending-description = 新着メッセージが一番下になります
default-sort-descending =
    .label = 降順
default-sort-descending-description = 新着メッセージが一番上になります
