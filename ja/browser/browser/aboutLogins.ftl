...
login-intro-instructions-fxa-passwords-help = <a data-l10n-name="passwords-help-link">パスワードのサポート</a> で詳細なヘルプを確認できます。
about-logins-intro-browser-only-import = 他のブラウザーでログイン情報を保存した場合は、<a data-l10n-name="import-link">そちらから { -brand-product-name } に@@Import-deki@@ます</a>。
