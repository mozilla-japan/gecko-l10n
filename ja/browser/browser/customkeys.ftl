...
customkeys-view-bookmarks-toolbar = ブックマークツールバーを切り替える
...
customkeys-nav-select-tab-1 = 1 個目のタブに移動
customkeys-nav-select-tab-2 = 2 個目のタブに移動
customkeys-nav-select-tab-3 = 3 個目のタブに移動
customkeys-nav-select-tab-4 = 4 個目のタブに移動
customkeys-nav-select-tab-5 = 5 個目のタブに移動
customkeys-nav-select-tab-6 = 6 個目のタブに移動
customkeys-nav-select-tab-7 = 7 個目のタブに移動
customkeys-nav-select-tab-8 = 8 個目のタブに移動
customkeys-nav-select-last-tab = 最後尾のタブに移動
