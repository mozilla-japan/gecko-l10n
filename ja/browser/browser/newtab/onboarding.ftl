...
mr2022-onboarding-colorway-primary-button-label-continue = 設定して続行
...
mr2022-onboarding-colorway-tooltip-default2 =
    .title = 現在の { -brand-short-name } の@@Colors@@
mr2022-onboarding-colorway-description-default = <b>現在の { -brand-short-name } の@@Colors@@を使用する。</b>
