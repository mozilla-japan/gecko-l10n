...
launch-on-login-spotlight-restore-checkbox = 前回の@@Window@@とタブを開く
...
set-default-menu-message-split-layout-subtitle =
    { PLATFORM() ->
        [macos] @@Default@@に設定して Dock に入れましょう。
...
set-default-menu-message-primary-button-short-variant = { -brand-short-name } を@@Default@@に設定
