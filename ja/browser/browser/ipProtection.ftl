...
ipprotection-feature-introduction-link-text-privacy-1 = <a data-l10n-name="learn-more-vpn">{ -brand-product-name } の組み込み VPN</a> はブラウジングの保護に役立ちます。プライバシー保護を維持するため複数個所から選んでください。
...
# Used for discovery callouts for both captive portal login and private browsing
ipprotection-feature-introduction-link-text-captive-portal-1 = 複数個所から選んで現在位置を隠し、<a data-l10n-name="learn-more-vpn">プライバシーを強化</a> しましょう。
...
ipprotection-location-selection-callout-description-1 = <a data-l10n-name="learn-more-vpn">{ -brand-product-name } の組み込み VPN</a> はブラウジング場所を選んでいただくか、接続速度が最も速い場所を代わりにピックアップします。
...
unauthenticated-choose-location-message-1 = ブラウジング場所を選んでいただくか、接続速度が最も速い場所を { -brand-product-name } が代わりにピックアップします。
