...
experimental-features-cookie-samesite-lax-by-default2 =
    .label = Cookie: @@Default@@で SameSite=Lax
experimental-features-cookie-samesite-lax-by-default2-description = Cookie に “SameSite” 属性が指定されていない場合、@@Default@@で “SameSite=Lax” として扱います。開発者は、“SameSite=None” が暗黙的に濫用されている現状にオプトインする必要があります。
