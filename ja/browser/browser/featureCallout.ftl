...
tab-groups-2026-onboarding-callout-title = Cut the clutter with tab groups(^^k
...
tab-groups-2026-onboarding-callout-subtitle = Group your tabs by task or topic. Drag more in as you go.(^^k
...
tab-groups-2026-onboarding-cta-button = Start a group(^^k
