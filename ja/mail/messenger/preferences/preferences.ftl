...
general-folder-options-header = Folder Management Options(^^k
recent-destinations-legend = Recent Destinations(^^k
recent-destinations-description = Options for listing and sorting folders where messages were recently moved to.(^^k
recent-sort-order-label = Sort order:(^^k
    .accesskey = S
recent-sort-order-mru =
    .label = Most recent(^^k
recent-sort-order-alphabetic =
    .label = Alphabetical(^^k
max-recent-label = Maximum number of recent folders:(^^k
    .accesskey = M
...
accent-color-legend = Accent Color(^^k
accent-color-label =
    .value = Define the color used for primary buttons and highlighted elements:(^^k
accent-color-os =
    .label = Follow operating system(^^k
accent-color-thunderbird =
    .label = Thunderbird blue(^^k
accent-color-purple =
    .label = Purple(^^k
accent-color-orange =
    .label = Orange(^^k
...
accent-color-teal =
    .label = Teal(^^k
accent-color-disabled-description = Accent colors are not supported in High Contrast mode.(^^k
