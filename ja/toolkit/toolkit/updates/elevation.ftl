...
sandbox-missing-unprivileged-namespaces = 現在ご使用のオペレーティングシステムでは、{ -brand-short-name } の一部のセキュリティ機能による保護が弱くなる可能性があります。
sandbox-unprivileged-namespaces-dismiss-button =
    .label = 今後は表示しない
    .accesskey = D
sandbox-unprivileged-namespaces-howtofix = この問題を解決するには
sandbox-content-disabled-warning = セキュリティサンドボックスが無効です。この設定はサポートされておらず、安全ではありません。
