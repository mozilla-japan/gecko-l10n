...
protocolhandler-mailto-os-handler-notificationbox = 常に { -brand-short-name } でメール送信のリンクを開きますか？
protocolhandler-mailto-os-handler-yes-confirm = { -brand-short-name } がメール送信のリンクを開く@@Default-@@アプリケーションに設定されました。
protocolhandler-mailto-os-handler-yes-button = @@Default@@に設定
...
protocolhandler-mailto-handler-yes-button = @@Default@@に設定
protocolhandler-mailto-handler-no-button = 後で
