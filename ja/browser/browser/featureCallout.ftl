...
tab-groups-2026-onboarding-callout-title = タブグループで整理整頓
...
tab-groups-2026-onboarding-callout-subtitle = タスクやトピックでタブをグループにできます。後からグループに追加もできます。
...
tab-groups-2026-onboarding-cta-button = グループをはじめる
