...
task-due-label =
    .value = 締切日時:
edit-intab-label =
    .label = 予定と ToDo をダイアログ@@Window@@ではなくタブで編集する
    .accesskey = t
prompt-delete-label =
...
missed-reminder-label =
    ...
    .accesskey = m
reminder-default-legend = @@Default-@@アラーム設定
default-snooze-label =
    .value = アラーム再通知の@@Default-@@間隔:
    .accesskey = S
event-alarm-label =
    .value = 予定のアラーム設定:
    .accesskey = e
