...
backup-file-moz-browser-restore-step-2-1 = Click “Restore your data” and select this file(^^k
...
backup-file-other-browser-restore-step-3-1 = Click “Restore your data” and select this file(^^k
