...
ipprotection-feature-introduction-link-text-privacy-1 = <a data-l10n-name="learn-more-vpn">{ -brand-product-name }’s built-in VPN</a> helps protect your browsing. Choose from several locations to keep where you browse more private.(^^k
...
# Used for discovery callouts for both captive portal login and private browsing
ipprotection-feature-introduction-link-text-captive-portal-1 = Get <a data-l10n-name="learn-more-vpn">extra privacy</a> by choosing from several locations to hide where you browse.(^^k
...
ipprotection-location-selection-callout-description-1 = <a data-l10n-name="learn-more-vpn">{ -brand-product-name }’s built-in VPN</a> lets you choose from several browsing locations, or let us pick the fastest one for you.(^^k
...
unauthenticated-choose-location-message-1 = Choose from several locations or let { -brand-product-name } pick the fastest one.(^^k
...
ipprotection-locations-unavailable-label = Unavailable(^^k
...
ip-protection-not-opted-in-4 =
    ...
    .message = Browse with extra protection by hiding your location.(^^k
