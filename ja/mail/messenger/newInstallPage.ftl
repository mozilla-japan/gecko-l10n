...
changed-desc-profiles = この { -brand-short-name } のインストールは@@New-CMD@@プロファイルが使用されます。プロファイルとは、{ -brand-product-name } がメールデータやパスワード、ユーザー設定、アドレス帳などの情報を保存する一連のファイル群のことです。
