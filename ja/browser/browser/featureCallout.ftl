...
sidebar-callout-survey-split-view = 同時に 2 つのウェブサイトを分割表示の両側で表示する
sidebar-callout-survey-keep-website-open = サイドバーでメールやカレンダーなどのウェブサイトを開いたままブラウジングする
sidebar-callout-survey-saved-websites = すべての保存したウェブサイトに簡単にアクセスする
sidebar-callout-survey-none-of-above = 上のどれでもない
