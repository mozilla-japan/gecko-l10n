...
account-hub-close-button =
    .title = Close(^^k
account-hub-email-manual-configuration = Manual configuration(^^k
account-hub-notification-unknown-host = Setup information found on 3rd party domain(^^k
account-hub-ssl-noencryption = None(^^k
...
account-hub-config-success-exchange = Configuration found for a Microsoft Exchange server(^^k
account-hub-config-success-guess = Configuration found by trying common server names(^^k
account-hub-config-success-disk = Configuration found in { -brand-short-name } installation(^^k
account-hub-config-success-isp = Configuration found at email provider(^^k
account-hub-config-success-unknown = Configuration found(^^k
