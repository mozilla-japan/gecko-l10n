...
account-provisioner-tab-title = サービスプロバイダーから@@New-CMD@@メールアドレスを取得
provisioner-searching-icon =
    .alt = 検索しています...
account-provisioner-title = @@New-CMD@@メールアドレスの作成
...
account-provisioner-mail-account-title = @@New-CMD@@メールアドレスの購入
