...
existing-user-tou-message = <strong>お知らせ</strong> 私たちは { -brand-short-name } <a data-l10n-name="terms-of-use-link">利用規約</a> を導入し、<a data-l10n-name="privacy-notice-link">プライバシー通知</a> を更新しました。内容をお読みの上、ご承諾願います。
# Infobar message for when the Privacy Notice is updated.
existing-user-privacy-notice-update-message = { -brand-short-name } の最新の機能を反映するため、<a data-l10n-name="privacy-notice-link">プライバシー通知</a> を更新しました。
