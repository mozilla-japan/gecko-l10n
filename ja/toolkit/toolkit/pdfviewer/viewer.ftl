...
pdfjs-document-properties-button =
    .title = 文書の@@Property@@...
pdfjs-document-properties-button-label = 文書の@@Property@@...
...
pdfjs-print-progress-message = 文書の@@Print@@を準備しています...
# Variables:
#   $progress (Number) - percent value
pdfjs-print-progress-percent = { $progress }%
pdfjs-print-progress-close-button = キャンセル
pdfjs-printing-not-supported = 警告: このブラウザーでは@@Print@@が完全にサポートされていません。
pdfjs-printing-not-ready = 警告: PDF を@@Print@@するための読み込みが終了していません。
...
pdfjs-editor-highlight-colorpicker-label = 強調@@Color@@
pdfjs-editor-colorpicker-button =
    .title = @@Color@@を変更します
pdfjs-editor-colorpicker-dropdown =
    .aria-label = @@Color@@の選択
...
pdfjs-views-manager-layers-title1 = レイヤー
    .title = レイヤー (ダブルクリックですべてのレイヤーを@@Default@@状態にリセット)
...
pdfjs-views-manager-status-warning-cut-label = @@Cut@@できませんでした。ページを更新してもう一度試してください。
...
pdfjs-views-manager-paste-button-before =
    .title = 最初のページの前に@@Paste-si@@ます
# Variables:
#   $page (Number) - the page number after which the paste button is.
pdfjs-views-manager-paste-button-after =
    .title = { $page } ページの後に@@Paste-si@@ます
...
pdfjs-digital-signature-properties-button =
    .title = デジタル署名の@@PropertyCMD@@
    .aria-label = デジタル署名の@@PropertyCMD@@
pdfjs-digital-signature-properties-button-label = デジタル署名の@@PropertyCMD@@
