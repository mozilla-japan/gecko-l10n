...
source-becky = { app-name-becky } から@@Import-suru@@
source-becky-description = { app-name-becky } からアドレス帳およびメッセージを@@Import-si@@ます。
...
from-app-becky = { app-name-becky } からの@@ImportNoun@@
...
profiles-pane-title-becky = { app-name-becky } からデータを@@Import-si@@ます。
