...
source-file = ファイルから@@ImportNoun@@

## Import from file selections

file-profile = バックアップしたプロファイル (.zip) の@@ImportNoun@@
file-calendar = カレンダーの@@ImportNoun@@
file-addressbook = アドレス帳の@@ImportNoun@@
